...
public class UseCaseHandler {
    ...
    public <T extends UseCase.RequestValues, R extends UseCase.ResponseValue> void execute(
        ...
        //JArroyo EspressoIdlingResource.increment(); // App is busy until further notice
        ...
        mUseCaseScheduler.execute(new Runnable() {
            ...
            public void run() {
                ...
                //JArroyoif (!EspressoIdlingResource.getIdlingResource().isIdleNow()) {
                //JArroyo    EspressoIdlingResource.decrement(); // Set app as idle.
                //JArroyo}
            }
        });
    }
